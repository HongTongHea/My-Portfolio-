...
import { FaGithub, FaFacebook, FaTelegram, FaEnvelope, FaBehance } from "react-icons/fa";
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2
          className={`text-3xl sm:text3xl font-bold  text-center md:text-left mb-16 ${darkMode ? "text-white" : "text-gray-900"
            }`}
        >
          Contact Me
        </h2>
