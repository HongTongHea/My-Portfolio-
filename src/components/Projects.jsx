...
const STORAGE_KEY = "graphic_uploaded_posters";

function loadStoredPosters() {
  try {
...
function saveStoredPosters(posters) {
  try {
...
export function Projects({ darkMode }) {
  ...
  const [uploadedPosters, setUploadedPosters] = useState(() => loadStoredPosters());
  ...
  const handleFormSubmit = () => {
    ...
    if (!formName.trim()) {
      setFormError("Please enter a poster name.");
      return;
    }
  ...
  // Only uploaded posters — newest first
  const posterProjects = [...uploadedPosters];
        ...
        >
          ...
          >
            ...
            <div className={`flex items-center justify-between px-6 py-4 border-b ${darkMode ? "border-gray-700" : "border-gray-200"}`}>
              ...
              <button onClick={closeUploadModal} className="p-1.5 rounded-full hover:bg-gray-200/20 transition-colors">
            ...
            <div className="px-6 py-5 flex flex-col gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-xl text-sm border outline-none transition-colors duration-200
                    ${darkMode
            ...
            <div className="flex gap-3 px-6 pb-6">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-sm font-semibold bg-indigo-600 hover:bg-indigo-700 text-white transition-colors duration-200"
              >
                Upload Poster
              </button>
            </div>
